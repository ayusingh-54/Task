...
const FootballMatchesPage = () => {
  ...
  useEffect(() => {
    ...
    fetchMatches(SPORTS.FOOTBALL);
    fetchPreviousMatches(SPORTS.FOOTBALL);
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-2 text-center">Football Matches</h1>
      <p className="text-center text-gray-600 dark:text-gray-400 mb-4">
        Latest football matches from top leagues and competitions
      </p>
      ...
      {currentMatches.length === 0 ? (
        <div className="text-center p-8 bg-gray-100 dark:bg-gray-800 rounded-lg">
          <p className="text-xl">
            {activeTab === "upcoming"
              ? "No upcoming football matches found. Check previous matches."
              : "No previous football matches found. Check upcoming matches."}
          </p>
